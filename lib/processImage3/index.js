 ...
 * @constructor
 */
var OriginalFile = function (dir, base_name, ext_name, versions) {
  var self = this;
 ...
 */
var processFile = function (FL, output_dir) {
  
  // use new array so that we can maintain the position of each file
  var version_names = new Array(FL.versions.length + 1);
...
module.exports = function (image_opts) {
  ...
  return BPromise.resolve()
    ...
    .map(function (file) {
      ...
      var FL = new OriginalFile(image_opts.dir, base_name, ext_name, image_opts.versions);
